...
class ImplicitAPI:
    ...
    v3_private_get_payment_methods = v3PrivateGetPaymentMethods = Entry('payment-methods', ['v3', 'private'], 'GET',{'cost': 1})
    v3_private_get_payment_methods_payment_method_id = v3PrivateGetPaymentMethodsPaymentMethodId = Entry('payment-methods/{payment_method_id}', ['v3', 'private'], 'GET', {'cost': 1})
